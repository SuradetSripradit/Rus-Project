...
@foreach ($head_course as $hc)
    @if ($hc["COURSE_HEAD_CODE"] == strval(Auth::user()->id))
        @php
            $flag = true;
            $fileteHeadCode = $hc["COURSE_CODE"];
        @endphp
    @break
    @endif
@endforeach
                                    ...
                                    {{-- Show Data In page --}}
                                        <table id="TabData" class="display nowrap text-center" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                @if ($pf->COURSE_CODE == $fileteHeadCode)
                                                @php
                                                    $cnt ++;
                                                @endphp
                                                    <tr>
